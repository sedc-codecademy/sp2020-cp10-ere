...
const loginModal = `<div class="modal fade in" id="formModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="padding-left: 16px;">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body modalFormBody">
            <div class="divTitleFormModal">
                <h1 class="titleFormModal">LOGIN</h1>
            </div>
            <div class="contentFormModal">
                ...
                <button type="button" class="buttonFormModal">LOGIN</button>
            </div>
        </div>
        <div class="modal-footer footerModalForm">
            <p class="modalFormSignUp">Don't have an account yet?</p>
            <div>
            <button type="button" class="buttonFormModalSignUp" data-toggle="modal" id="signUpDivModal" data-target="#signUpFormModal"  data-dismiss="modal">SIGN UP</button>
            </div>
        </div>
    </div>
</div>
</div>`
const signUpModal = `<div  id="signUpFormModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="signUpModalTitle" aria-hidden="true" style="padding-left: 0px;">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer footerModalForm">
                        ...
                        <div><button type="button" class="buttonFormModalSignUp" id="signInFormModal data-toggle="modal" data-target="#formModal"  tabindex = "0" >LOG IN</button></div>
                    </div>
                </div>
            </div>
            </div>`;
...
let divLoginModal = document.getElementById('loginDivModal');
let divSignUpModal = document.getElementById("signUpDivModal");
...
function printMostOrderedProducts() {
    ...
    divLoginModal.innerHTML = loginModal;
    divSignUpModal.innerHTML = signUpModal;
...
function printItemsCard(element, array, column) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        <div data-toggle="modal" class="${column === 12 ? 'pointer listCardElement' : 'pointer'}" data-target="${array[
			i
		].dataForObject.mainCategory != 'Drink'
			? '#foodModal'
